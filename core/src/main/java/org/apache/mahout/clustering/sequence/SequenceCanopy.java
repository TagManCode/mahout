 ...
 */
public class SequenceCanopy extends SequenceDistanceMeasureCluster {
  
  /** Used for deserialization as a writable */
  public SequenceCanopy() { }
   ...
   */
  public SequenceCanopy(Vector center, int canopyId, DistanceMeasure measure) {
