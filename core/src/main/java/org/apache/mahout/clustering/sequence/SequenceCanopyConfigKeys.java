...
public final class SequenceCanopyConfigKeys {
    ...
    public static SequenceCanopyClusterer configureCanopyClusterer(Configuration configuration) {
        ...
        SequenceCanopyClusterer canopyClusterer = new SequenceCanopyClusterer(measure, t1, t2);
